...
def home(request):
    return render(request, "phishing_detection/home.html")

def result(request):
    return render(request, "phishing_detection/result.html")

def error(request):
    return render(request, "phishing_detection/error.html")
...
# Define a function to classify a website as legitimate or phishing
def classify_website(url):
    ...
    return is_phishing
from .utils import classify_website
